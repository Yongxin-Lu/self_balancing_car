...
#define SPI2_CE_LOW()    GPIO_ResetBits(GPIOA,GPIO_Pin_9)
#define SPI2_CE_HIGH()   GPIO_SetBits(GPIOA,GPIO_Pin_9)
#define SPI2_CSN_LOW()   GPIO_ResetBits(GPIOA,GPIO_Pin_8)
#define SPI2_CSN_HIGH()  GPIO_SetBits(GPIOA,GPIO_Pin_8)

#define SI24R1_IRQ() GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_12)
...
#define TX_PAYLO_WIDTH 6
#define RX_PAYLO_WIDTH 8
