...
#define SPI2_CE_LOW()    GPIO_ResetBits(GPIOA,GPIO_Pin_11)
#define SPI2_CE_HIGH()   GPIO_SetBits(GPIOA,GPIO_Pin_11)
#define SPI2_CSN_LOW()   GPIO_ResetBits(GPIOB,GPIO_Pin_12)
#define SPI2_CSN_HIGH()  GPIO_SetBits(GPIOB,GPIO_Pin_12)

#define SI24R1_IRQ() GPIO_ReadInputDataBit(GPIOA,GPIO_Pin_8)
